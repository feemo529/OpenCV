...
//	//训练数据
//	Mat sample, labls;
//	FileStorage fread("./images/point.yml", FileStorage::READ);
//	fread["data"] >> sample;
//	fread["labls"] >> labls;
//	fread.release();
//
...
//	{
//		Point2f point;
//		point.x = sample.at<float>(i, 0);
//		point.y = sample.at<float>(i, 1);
...
//
//	//训练模型
//	model->train(TrainData::create(sample, ROW_SAMPLE, labls));
//
//	//用模型对图像中全部像素点进行分类
